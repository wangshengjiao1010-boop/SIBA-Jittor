...
- `final_retrain_20260803/`: final revision validation with a new 60-epoch Jittor checkpoint, complete batch logs, four losses, 706-image inference, seven metrics and red-box qualitative comparisons.
