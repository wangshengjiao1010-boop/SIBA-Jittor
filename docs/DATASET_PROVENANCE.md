...
- Training pairs: `1083`
- Test pairs: `361`
- Pair sizes and SHA256 values are stored in `data_manifests/msrs_train.json` and `data_manifests/msrs_test.json`.
...
- Selected pairs: `200`
- Selection seed: `2025`
- Selected filenames and hashes are stored in `data_manifests/roadscene_200_seed2025.json`.
...
- Pair hashes are stored in `data_manifests/tno_test.json`.
