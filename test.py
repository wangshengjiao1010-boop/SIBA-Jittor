...
def parse_runtime_args():
    parser = argparse.ArgumentParser(description="Test SIBA with Jittor")
    parser.add_argument("--checkpoint", default="checkpoint/SIBA_epoch60.pkl")
    parser.add_argument("--data-dir", default="datasets/test/MSRS")
    parser.add_argument("--output", default="results/fused/MSRS")
...
model_path = runtime_args.checkpoint
testdata_path = runtime_args.data_dir
result_save_path = runtime_args.output
