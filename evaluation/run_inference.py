...
def main():
    ...
    parser.add_argument(
        "--pytorch-root",
        type=Path,
        help="Separately cloned official SIBA repository; required for PyTorch",
    )
    ...
    if args.framework == "pytorch":
        if args.pytorch_root is None:
            parser.error("--pytorch-root is required for PyTorch inference")
        source = args.pytorch_root.resolve()
